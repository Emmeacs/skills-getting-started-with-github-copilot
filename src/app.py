...
activities = {
    ...
    "Swimming Club": {
        "description": "Swim training and wellness sessions",
        "schedule": "Mondays and Wednesdays, 5:00 PM - 6:00 PM",
        "max_participants": 15,
        "participants": ["noah@mergington.edu", "mia@mergington.edu"]
    },
    "Art Club": {
        "description": "Create drawings, paintings, and collaborative art",
        "schedule": "Wednesdays, 3:30 PM - 5:00 PM",
        "max_participants": 16,
        "participants": ["ava@mergington.edu", "lucas@mergington.edu"]
    },
    "Drama Club": {
        "description": "Perform scenes, learn acting skills, and rehearse plays",
    ...
    "Math Club": {
        "description": "Solve math puzzles and study advanced topics",
